...
setup(
    ...
    license='MIT',
    entry_points={"console_scripts": ["pyppl_report = pyppl_report.console:main", "pyppl-report = pyppl_report.console:main"]},
    ...
    install_requires=['cmdy', 'panflute==1.11.*', 'pyparam', 'pyppl==2.*,>=2.0.0', 'pyyaml==5.*,>=5.0.0'],
