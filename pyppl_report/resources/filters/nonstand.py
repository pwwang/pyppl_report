"""
Make html reports non-standalone, allowing css, javascript and images
saved in mediadir.
"""
...
def action(elem, doc):
    ...
    if ((isinstance(elem, pf.Image) and elem.url.startswith('/'))
            or (isinstance(elem, pf.Link) and elem.title == 'file-download')):
